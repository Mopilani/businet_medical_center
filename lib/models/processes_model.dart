...
import 'package:businet_medical_center/models/shift_reports/shift_reports_maker.dart';
...
String timeToString(DateTime datetime, [String sparator = '-']) {
  return '${datetime.hour}$sparator${datetime.minute}$sparator${datetime.second}';
}
