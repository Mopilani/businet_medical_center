...
class AnalysisGroupView extends StatefulWidget {
  const AnalysisGroupView({Key? key}) : super(key: key);

  @override
  State<AnalysisGroupView> createState() => _AnalysisGroupViewState();
}

class _AnalysisGroupViewState extends State<AnalysisGroupView> {
