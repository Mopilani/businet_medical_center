...
class LabAnalysisGroupView extends StatefulWidget {
  const LabAnalysisGroupView({Key? key}) : super(key: key);

  @override
  State<LabAnalysisGroupView> createState() => _LabAnalysisGroupViewState();
}

class _LabAnalysisGroupViewState extends State<LabAnalysisGroupView> {
  List<AnalysisGroupModel> models = [];
  TextEditingController titleController = TextEditingController();
  AnalysisGroupModel? selectedModel;
        ...
        child: Column(
          children: [
            updater.UpdaterBlocWithoutDisposer(
              ...
              update: (context, s) {
                return Expanded(
                  child: FutureBuilder<List<AnalysisGroupModel>>(
