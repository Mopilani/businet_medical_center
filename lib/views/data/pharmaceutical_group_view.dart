...
class PharmaceuticalGroupView extends StatefulWidget {
  const PharmaceuticalGroupView({Key? key}) : super(key: key);

  @override
  State<PharmaceuticalGroupView> createState() =>
      _PharmaceuticalGroupViewState();
}

class _PharmaceuticalGroupViewState extends State<PharmaceuticalGroupView> {
  List<PharmaceuticalGroupModel> models = [];
  TextEditingController titleController = TextEditingController();
  PharmaceuticalGroupModel? selectedModel;
        ...
        child: Column(
          children: [
            updater.UpdaterBlocWithoutDisposer(
              ...
              update: (context, s) {
                return Expanded(
                  child: FutureBuilder<List<PharmaceuticalGroupModel>>(
                    future: PharmaceuticalGroupModel.getAll(),
                      ...
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            await PharmaceuticalGroupModel(
                              0,
