...
class DosingListView extends StatefulWidget {
  const DosingListView({Key? key}) : super(key: key);

  @override
  State<DosingListView> createState() => _DosingListViewState();
}

class _DosingListViewState extends State<DosingListView> {
  List<DoseModel> models = [];
  TextEditingController descriptionController = TextEditingController();
  String? selectedAnalysisGroupTitle;
  DoseModel? selectedModel;
        ...
        child: Column(
          children: [
            updater.UpdaterBlocWithoutDisposer(
              ...
              update: (context, s) {
                return Expanded(
                  child: FutureBuilder<List<DoseModel>>(
                    future: DoseModel.getAll(),
