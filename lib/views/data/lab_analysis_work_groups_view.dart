...
class LabAnalysisWorkGroupView extends StatefulWidget {
  const LabAnalysisWorkGroupView({Key? key}) : super(key: key);

  @override
  State<LabAnalysisWorkGroupView> createState() => _LabAnalysisWorkGroupViewState();
}

class _LabAnalysisWorkGroupViewState extends State<LabAnalysisWorkGroupView> {
  List<AnalysisWorkGroupModel> models = [];
  TextEditingController titleController = TextEditingController();
  AnalysisWorkGroupModel? selectedModel;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('مجموعات العمل'),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            updater.UpdaterBlocWithoutDisposer(
              ...
              update: (context, s) {
                return Expanded(
                  child: FutureBuilder<List<AnalysisWorkGroupModel>>(
                    future: AnalysisWorkGroupModel.getAll(),
