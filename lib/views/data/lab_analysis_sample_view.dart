...
class LabAnalysisSampleView extends StatefulWidget {
  const LabAnalysisSampleView({Key? key}) : super(key: key);

  @override
  State<LabAnalysisSampleView> createState() => _LabAnalysisSampleViewState();
}

class _LabAnalysisSampleViewState extends State<LabAnalysisSampleView> {
  List<AnalysisSampleModel> models = [];
  TextEditingController titleController = TextEditingController();
  AnalysisSampleModel? selectedModel;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('العينات'),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            updater.UpdaterBlocWithoutDisposer(
              ...
              update: (context, s) {
                return Expanded(
                  child: FutureBuilder<List<AnalysisSampleModel>>(
                    future: AnalysisSampleModel.getAll(),
